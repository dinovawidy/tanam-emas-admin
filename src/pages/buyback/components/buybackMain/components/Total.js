...
const Total = ({ totalTransaction, totalWeight, totalQuantity }) => {
  ...
  return (
    <>
      ...
      <div className="pb-2">
        ...
        <p className="text-md font-bold">{totalTransaction}</p>
      </div>
      <div className="pb-2">
        <p className="text-sm font-medium">{t("buyback.total_weight")}</p>
        <p className="text-md font-bold">{totalWeight} gram</p>
      </div>
      <div className="pb-2">
        <p className="text-sm font-medium">{t("buyback.total_quantity")}</p>
        <p className="text-md font-bold">{totalQuantity} pcs</p>
      </div>
    </>
  );
};
